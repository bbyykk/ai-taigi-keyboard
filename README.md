...
The Linux desktop port provides both an Fcitx 5 addon and an IBus engine,
supporting Ubuntu GNOME, X11, and Wayland.
See [`linux/README.md`](linux/README.md), or run `make linux-install` after
installing the Rust and Fcitx 5 development packages.
