...
.PHONY: build test test-crate doc dict dogfood help linux-build linux-install \
...
linux-build:
	...
	cmake -S linux -B build/linux-system -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr
	cmake --build build/linux-system -j2

linux-install: linux-build
	sudo cmake --install build/linux-system
...
help:
	...
	@echo "  make linux-build        Build the Ubuntu/Fcitx 5 desktop input method"
	@echo "  make linux-install      Install the Ubuntu/Fcitx 5 desktop input method"
